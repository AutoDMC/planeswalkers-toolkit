...
MTG;
    ...
    {
        $result = $this->createCollection($type, $name, $description);

        echo "{$result['name']} {$result['type']} created.\n";
        return true;
    }

    function createCollection($type, $name = null, $description = null) {
        ...
        $this->fileStructure['description'] = "Autogenerated stack on " . date(DATE_RFC822);
        ...
        $yamlStructure = Yaml::dump($this->fileStructure);

        file_put_contents($filename, $yamlStructure);
